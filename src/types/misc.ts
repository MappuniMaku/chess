...
export type IValidationErrorsMessages = Partial<
  Record<IValidationError, string>
>;

export type IFormValidationErrors<FormValues> = Partial<
  Record<keyof FormValues, IValidationError>
>;
